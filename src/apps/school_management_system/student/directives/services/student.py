...
from src.apps.school_management_system.student.v1.schemas.student import StudentIn
from src.apps.school_management_system.student.models.student import Student

...
# from src.apps.school_management_system.schedule_management.models.subject_schedule import (
#     SubjectSchedule,
# )
...
#             Q(teacher_id=teacher_id),Q(from_date__gte=from_date), Q(to_date__lte=to_date)
#         )
...
#             Q(teacher_id=teacher_id), Q(subject=subject)
#         )
...
#             teacher_id=teacher_id, subject=subject, from_date=from_date, to_date=to_date
#         )
